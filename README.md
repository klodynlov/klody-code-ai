...
![Coverage](https://img.shields.io/badge/coverage-80.5%25-success)
...
| ✅ **Production-grade** | 2030 tests, coverage 80,5 %, CI 5 jobs (sécurité + régression + contrat), branch protection + signed commits. |
...
| Tests | `pytest` — **2030 tests** (+20 skipped) · coverage 80,5 % |
