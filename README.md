...
![Tests](https://img.shields.io/badge/tests-2068%20passing-success)
...
> **Status** : v2.1+ stable · **2068 tests** · CI à gates (bandit / gitleaks / pip-audit / coverage) · cerveau MLX `Qwen3.6-35B-A3B` · client **et** serveur MCP
...
| ✅ **Production-grade** | 2068 tests, coverage 82 %, CI 5 jobs (sécurité + régression + contrat), branch protection + signed commits. |
...
| Tests | `pytest` — **2068 tests** (+20 skipped) · coverage 82 % |
...
```bash
python -m pytest tests/ -q                         # 2068 passing
