<!-- ════════════════════════════════════════════════════════════════════════
  ...
  Pour qu'il s'affiche sur https://github.com/klodynlov :
    1. Créer un repo PUBLIC nommé EXACTEMENT  klodynlov  (= ton pseudo).
    2. Y mettre ce fichier sous le nom  README.md.
    3. Compléter les [placeholders] (liens, email) et choisir tes projets phares.
  (Ce fichier vit ici dans klody-code-ai/docs/ comme source versionnée.)
═════════════════════════════════════════════════════════════════════════ -->
